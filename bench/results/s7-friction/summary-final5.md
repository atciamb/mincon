...
| infeasible_start_far | Y 116 |
| bad_scaling | Y 31 |
| noisy_simulator | Y 107 |
| box_lsq | Y 1485 |
...
|---|---|---|---|---|---:|---:|---:|---:|---|
| chainrosen20 | Y gap 6.2e-11 | True | 1 | n | 2487 | 0 | 113 | 0.03 | First-order optimality and constraint tolerances satisfied. |
| odefit | Y gap 2.3e-13 (param err 2.3e-07, ok) | True | 1 | n | 100 | 0 | 16 | 0.63 | First-order optimality and constraint tolerances satisfied. |
...
| infeasible_start_far | Y gap 2.1e-16 | True | 1 | Y | 116 | 0 | 2 | 0.00 | First-order optimality and constraint tolerances satisfied. |
| bad_scaling | Y gap -2.7e-13 | True | 1 | Y | 31 | 37 | 7 | 0.00 | First-order optimality and constraint tolerances satisfied. |
| noisy_simulator | Y gap -9.8e-10 | True | 1 | n | 107 | 0 | 12 | 0.00 | First-order optimality and constraint tolerances satisfied. |
| box_lsq | Y gap 1.4e-17 | True | 1 | Y | 1485 | 0 | 2 | 0.01 | First-order optimality and constraint tolerances satisfied. |
