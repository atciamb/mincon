...
|---|---|---|---|---|---:|---:|---:|---:|---|
| chainrosen20 | Y gap 1.1e-06 | False | 0 | n | 3014 | 0 | 133 | 0.99 | Solver stopped prematurely. |
| odefit | Y gap 1.4e-13 (param err 1.7e-07, ok) | True | 1 | n | 160 | 0 | 35 | 0.29 | Local minimum found that satisfies the constraints. |
| portfolio_risk | Y gap 2.2e-06 | True | 1 | n | 250 | 250 | 26 | 0.19 | Local minimum found that satisfies the constraints. |
| pressure_vessel | Y gap 1.2e-08 | True | 1 | n | 63 | 63 | 7 | 0.17 | Local minimum found that satisfies the constraints. |
| nan_region | Y gap 2.0e-08 | True | 1 | Y | 32 | 32 | 9 | 0.23 | Local minimum found that satisfies the constraints. |
| hs71 | Y gap 2.4e-07 | True | 1 | Y | 46 | 46 | 8 | 0.10 | Local minimum found that satisfies the constraints. |
| linear_only | Y gap 1.2e-12 | True | 1 | n | 142 | 0 | 19 | 0.11 | Local minimum found that satisfies the constraints. |
| with_args | Y gap 5.1e-14 (param err 1.9e-07, ok) | True | 1 | Y | 86 | 0 | 18 | 0.12 | Local minimum found that satisfies the constraints. |
| wrong_gradient | n gap 1.0e+00 | True | 2 | n | 45 | 0 | 2 | 0.06 | Local minimum possible. Constraints satisfied. |
| infeasible_start_far | Y gap 7.8e-07 | True | 1 | n | 199 | 0 | 17 | 0.07 | Local minimum found that satisfies the constraints. |
| bad_scaling | n gap 1.6e+01 | True | 1 | Y | 20 | 20 | 5 | 0.07 | Local minimum found that satisfies the constraints. |
| noisy_simulator | Y gap 3.2e-07 | True | 1 | n | 183 | 0 | 33 | 0.13 | Local minimum found that satisfies the constraints. |
| box_lsq | n gap 1.3e-03 | False | 0 | n | 3009 | 0 | 58 | 0.16 | Solver stopped prematurely. |
| equality_circle | Y gap -1.4e-07 | True | 1 | n | 44 | 44 | 10 | 0.13 | Local minimum found that satisfies the constraints. |

### fmincon-sqp

| problem | attained | reported | exit | KKT | f_model | c_model | nit | wall s | message |
|---|---|---|---|---|---:|---:|---:|---:|---|
| chainrosen20 | n gap 4.5e+00 | False | 0 | n | 2014 | 0 | 86 | 0.11 | Solver stopped prematurely. |
...
| linear_only | Y gap 4.5e-14 | True | 1 | Y | 92 | 0 | 11 | 0.02 | Local minimum found that satisfies the constraints. |
...
| box_lsq | Y gap 2.5e-05 | False | 0 | n | 5049 | 0 | 98 | 0.20 | Solver stopped prematurely. |
...
| odefit | Y gap 2.3e-13 (param err 2.3e-07, ok) | True | 1 | n | 96 | 0 | 16 | 0.42 | First-order optimality and constraint tolerances satisfied. |
| portfolio_risk | Y gap 0.0e+00 | True | 1 | Y | 111 | 129 | 11 | 0.00 | First-order optimality and constraint tolerances satisfied. |
...
| wrong_gradient | n gap 1.0e+00 | False | 2 | n | 477 | 0 | 7 | 0.00 | Local minimum possible. Step size below tolerance; constraints satisfied. |
| infeasible_start_far | Y gap -4.3e-12 | True | 1 | Y | 99 | 0 | 7 | 0.00 | First-order optimality and constraint tolerances satisfied. |
| bad_scaling | n gap 1.2e+02 | True | 1 | n | 64 | 76 | 16 | 0.00 | First-order optimality and constraint tolerances satisfied. |
| noisy_simulator | Y gap -9.8e-10 | True | 1 | n | 86 | 0 | 12 | 0.00 | First-order optimality and constraint tolerances satisfied. |
| box_lsq | Y gap 4.2e-06 | True | 1 | n | 8595 | 0 | 166 | 0.05 | First-order optimality and constraint tolerances satisfied. |
...
| odefit | Y gap 3.2e-08 (param err 8.9e-05, ok) | True | 0 | n | 104 | 0 | 23 | 0.39 | Optimization terminated successfully |
| portfolio_risk | Y gap -4.4e-08 | True | 0 | Y | 99 | 100 | 11 | 0.00 | Optimization terminated successfully |
...
| box_lsq | Y gap 9.8e-05 | True | 0 | n | 3213 | 0 | 63 | 0.06 | Optimization terminated successfully |
...
| problem | attained | reported | exit | KKT | f_model | c_model | nit | wall s | message |
|---|---|---|---|---|---:|---:|---:|---:|---|
| chainrosen20 | Y gap 6.2e-11 | True | 1 | n | 8001 | 0 | 326 | 0.55 | `gtol` termination condition is satisfied. |
| odefit | Y gap 6.5e-15 (param err 1.8e-08, ok) | True | 2 | n | 376 | 0 | 98 | 2.16 | `xtol` termination condition is satisfied. |
...
| hs71 | Y gap 1.5e-07 | True | 1 | Y | 650 | 650 | 136 | 0.13 | `gtol` termination condition is satisfied. |
| linear_only | Y gap 1.8e-14 | True | 1 | Y | 175 | 0 | 34 | 0.02 | `gtol` termination condition is satisfied. |
| with_args | Y gap 1.8e-14 (param err 1.2e-07, ok) | True | 1 | Y | 100 | 0 | 33 | 0.05 | `gtol` termination condition is satisfied. |
| wrong_gradient | n gap 1.1e+00 | True | 2 | n | 407 | 0 | 339 | 0.13 | `xtol` termination condition is satisfied. |
| infeasible_start_far | Y gap 2.7e-06 | True | 1 | n | 462 | 0 | 49 | 0.04 | `gtol` termination condition is satisfied. |
| bad_scaling | n gap 1.6e+01 | True | 2 | Y | 84 | 84 | 106 | 0.08 | `xtol` termination condition is satisfied. |
| noisy_simulator | Y gap 5.2e-08 | True | 1 | n | 255 | 0 | 47 | 0.05 | `gtol` termination condition is satisfied. |
| box_lsq | Y gap 2.2e-06 | True | 1 | n | 7803 | 0 | 162 | 0.40 | `gtol` termination condition is satisfied. |
| equality_circle | Y gap -1.7e-09 | True | 1 | n | 44 | 44 | 18 | 0.01 | `gtol` termination condition is satisfied. |

MATLAB/Python definition agreement at x0 over 28 records: worst relative difference 3.6e-11; records above 1e-8: none.
