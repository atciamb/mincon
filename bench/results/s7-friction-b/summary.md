...
|---|---|---|---|---|---:|---:|---:|---:|---|
| chainrosen20 | Y gap 1.1e-06 | False | 0 | n | 3014 | 0 | 133 | 1.28 | Solver stopped prematurely. |
| odefit | Y gap 1.4e-13 (param err 1.7e-07, ok) | True | 1 | n | 160 | 0 | 35 | 0.19 | Local minimum found that satisfies the constraints. |
| portfolio_risk | Y gap 2.2e-06 | True | 1 | n | 250 | 250 | 26 | 0.17 | Local minimum found that satisfies the constraints. |
| pressure_vessel | Y gap 1.2e-08 | True | 1 | n | 63 | 63 | 7 | 0.11 | Local minimum found that satisfies the constraints. |
| nan_region | Y gap 2.0e-08 | True | 1 | Y | 32 | 32 | 9 | 0.16 | Local minimum found that satisfies the constraints. |
| hs71 | Y gap 2.4e-07 | True | 1 | Y | 46 | 46 | 8 | 0.09 | Local minimum found that satisfies the constraints. |
...
| wrong_gradient | n gap 1.0e+00 | True | 2 | n | 45 | 0 | 2 | 0.04 | Local minimum possible. Constraints satisfied. |
| infeasible_start_far | Y gap 7.8e-07 | True | 1 | n | 199 | 0 | 17 | 0.05 | Local minimum found that satisfies the constraints. |
| bad_scaling | n gap 1.6e+01 | True | 1 | Y | 20 | 20 | 5 | 0.04 | Local minimum found that satisfies the constraints. |
| noisy_simulator | Y gap 3.2e-07 | True | 1 | n | 183 | 0 | 33 | 0.09 | Local minimum found that satisfies the constraints. |
| box_lsq | n gap 1.3e-03 | False | 0 | n | 3009 | 0 | 58 | 0.10 | Solver stopped prematurely. |
| equality_circle | Y gap -1.4e-07 | True | 1 | n | 44 | 44 | 10 | 0.08 | Local minimum found that satisfies the constraints. |
| heatflux_design | Y gap 1.7e-07 | True | 1 | Y | 382 | 0 | 18 | 0.20 | Local minimum found that satisfies the constraints. |

### fmincon-sqp

| problem | attained | reported | exit | KKT | f_model | c_model | nit | wall s | message |
|---|---|---|---|---|---:|---:|---:|---:|---|
| chainrosen20 | n gap 4.5e+00 | False | 0 | n | 2014 | 0 | 86 | 0.09 | Solver stopped prematurely. |
| odefit | Y gap 2.0e-13 (param err 2.9e-07, ok) | True | 2 | n | 135 | 0 | 28 | 0.03 | Local minimum possible. Constraints satisfied. |
...
| nan_region | Y gap -6.1e-10 | True | 1 | Y | 18 | 18 | 4 | 0.01 | Local minimum found that satisfies the constraints. |
...
| box_lsq | Y gap 2.5e-05 | False | 0 | n | 5049 | 0 | 98 | 0.11 | Solver stopped prematurely. |
...
| heatflux_design | Y gap 4.2e-08 | True | 1 | Y | 477 | 0 | 16 | 5.90 | First-order optimality and constraint tolerances satisfied. |

### scipy-slsqp

| problem | attained | reported | exit | KKT | f_model | c_model | nit | wall s | message |
|---|---|---|---|---|---:|---:|---:|---:|---|
| chainrosen20 | n gap 4.0e+00 | False | 9 | n | 2188 | 0 | 100 | 0.05 | Iteration limit reached |
| odefit | Y gap 3.2e-08 (param err 8.9e-05, ok) | True | 0 | n | 104 | 0 | 23 | 0.47 | Optimization terminated successfully |
...
| odefit | Y gap 6.5e-15 (param err 1.8e-08, ok) | True | 2 | n | 376 | 0 | 98 | 2.33 | `xtol` termination condition is satisfied. |
| portfolio_risk | Y gap 4.3e-05 | True | 1 | n | 153 | 153 | 22 | 0.03 | `gtol` termination condition is satisfied. |
| pressure_vessel | Y gap 1.9e-07 | True | 1 | n | 655 | 655 | 74 | 0.11 | `gtol` termination condition is satisfied. |
| nan_region | n gap 1.6e-04 | True | 1 | n | 21 | 21 | 11 | 0.01 | `gtol` termination condition is satisfied. |
| hs71 | Y gap 1.5e-07 | True | 1 | Y | 650 | 650 | 136 | 0.16 | `gtol` termination condition is satisfied. |
...
| wrong_gradient | n gap 1.1e+00 | True | 2 | n | 407 | 0 | 339 | 0.16 | `xtol` termination condition is satisfied. |
| infeasible_start_far | Y gap 2.7e-06 | True | 1 | n | 462 | 0 | 49 | 0.05 | `gtol` termination condition is satisfied. |
| bad_scaling | n gap 1.6e+01 | True | 2 | Y | 84 | 84 | 106 | 0.07 | `xtol` termination condition is satisfied. |
| noisy_simulator | Y gap 5.2e-08 | True | 1 | n | 255 | 0 | 47 | 0.04 | `gtol` termination condition is satisfied. |
| box_lsq | Y gap 2.2e-06 | True | 1 | n | 7803 | 0 | 162 | 0.42 | `gtol` termination condition is satisfied. |
| equality_circle | Y gap -1.7e-09 | True | 1 | n | 44 | 44 | 18 | 0.01 | `gtol` termination condition is satisfied. |
| heatflux_design | Y gap 2.3e-06 | True | 1 | Y | 620 | 0 | 37 | 16.58 | `gtol` termination condition is satisfied. |
