# s6v5-final5-rows: a disclosed second look at the sealed round-5 set, September 13, 2026
...
**The honest caveat, stated once: the sealed set has now been looked at twice.** That is why this
is filed as a disclosure and not as a claim, why no tuning follows it, and why `docs/17` item 19
keeps its original numbers. A further claim needs a new sealed round.
