# Analysis of C:\Users\andyc\OneDrive\Desktop\python_fmincon\mincon-research\bench\results\abl-se\scored-auto.jsonl

169 problems, solvers: mincon@bfgs_rescale=0, mincon@kkt_pivot_signs=auto; duplicates overwritten: 0
...
| mincon@kkt_pivot_signs=auto | 158 | 166 | 0.952 | 88 | 130 | 0 |

## Attainment by family

| family | n | mincon@bfgs_rescale=0 | mincon@kkt_pivot_signs=auto |
|---|---:|---:|---:|
...
|---|---:|---:|---:|---:|---:|---|---:|---|---:|
| mincon@kkt_pivot_signs=auto | 158 | 0 | 0 | 8 | +0.0 | [+0.0, +0.0] | 1.01 | [1.00, 1.02] | 158 |

## Performance profile points (total_model; fraction of problems solved within tau x best)

| tau | mincon@bfgs_rescale=0 | mincon@kkt_pivot_signs=auto |
|---:|---:|---:|
| 1 | 1.00 | 0.99 |
| 2 | 1.00 | 0.99 |
| 4 | 1.00 | 0.99 |
