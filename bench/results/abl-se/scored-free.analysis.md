# Analysis of C:\Users\andyc\OneDrive\Desktop\python_fmincon\mincon-research\bench\results\abl-se\scored-free.jsonl

169 problems, solvers: mincon@bfgs_rescale=0, mincon@kkt_pivot_signs=free; duplicates overwritten: 0
...
| mincon@kkt_pivot_signs=free | 158 | 166 | 0.952 | 88 | 130 | 0 |

## Attainment by family

| family | n | mincon@bfgs_rescale=0 | mincon@kkt_pivot_signs=free |
|---|---:|---:|---:|
...
|---|---:|---:|---:|---:|---:|---|---:|---|---:|
| mincon@kkt_pivot_signs=free | 158 | 0 | 0 | 8 | +0.0 | [+0.0, +0.0] | 1.01 | [1.00, 1.02] | 158 |

## Performance profile points (total_model; fraction of problems solved within tau x best)

| tau | mincon@bfgs_rescale=0 | mincon@kkt_pivot_signs=free |
|---:|---:|---:|
| 1 | 1.00 | 0.99 |
| 2 | 1.00 | 0.99 |
| 4 | 1.00 | 0.99 |
