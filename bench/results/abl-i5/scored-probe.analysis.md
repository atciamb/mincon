# Analysis of C:\Users\andyc\OneDrive\Desktop\python_fmincon\mincon-research\bench\results\abl-i5\scored-probe.jsonl

172 problems, solvers: mincon@bfgs_rescale=0, mincon@quadratic_probe=true; duplicates overwritten: 0
...
| family | n | mincon@bfgs_rescale=0 | mincon@quadratic_probe=true |
|---|---:|---:|---:|
...
|---|---:|---:|---:|---:|---:|---|---:|---|---:|
| mincon@quadratic_probe=true | 158 | 0 | 0 | 8 | +0.0 | [+0.0, +0.0] | 1.04 | [0.90, 1.16] | 158 |

## Performance profile points (total_model; fraction of problems solved within tau x best)

| tau | mincon@bfgs_rescale=0 | mincon@quadratic_probe=true |
|---:|---:|---:|
| 1 | 0.89 | 0.11 |
| 2 | 0.96 | 0.97 |
| 4 | 0.99 | 0.99 |
